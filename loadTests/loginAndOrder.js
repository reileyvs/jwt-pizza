  ...
  group('page_1 - https://pizza.jwtpizza.click/', function () {
    response = http.get('https://pizza.jwtpizza.click/', {
      headers: {
        ...
        'if-modified-since': 'Wed, 12 Mar 2025 00:19:07 GMT',
        'if-none-match': '"62979a262d099a6460b749ab00509b3a"',
        priority: 'u=0, i',
    ...
    response = http.options('https://pizza-service.jwtpizza.click/api/auth', null, {
      headers: {
        accept: '*/*',
        'accept-encoding': 'gzip, deflate, br, zstd',
        'accept-language': 'en-US,en;q=0.9',
    ...
    response = http.options('https://pizza-service.jwtpizza.click/api/order/menu', null, {
      headers: {
        accept: '*/*',
        'accept-encoding': 'gzip, deflate, br, zstd',
        'accept-language': 'en-US,en;q=0.9',
    ...
    response = http.get('https://pizza-service.jwtpizza.click/api/franchise', {
      headers: {
        accept: '*/*',
        'accept-encoding': 'gzip, deflate, br, zstd',
        'accept-language': 'en-US,en;q=0.9',
    ...
    response = http.options('https://pizza-service.jwtpizza.click/api/franchise', null, {
      headers: {
        accept: '*/*',
        'accept-encoding': 'gzip, deflate, br, zstd',
        'accept-language': 'en-US,en;q=0.9',
    ...
    response = http.options('https://pizza-service.jwtpizza.click/api/order', null, {
      headers: {
        accept: '*/*',
        'accept-encoding': 'gzip, deflate, br, zstd',
        'accept-language': 'en-US,en;q=0.9',
